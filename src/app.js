...
function resumeContent() {
  return `<iframe class="resume-pdf-viewer" src="${escape(profile.resume)}" title="${escape(profile.name)} résumé PDF"><a href="${escape(profile.resume)}" target="_blank" rel="noopener noreferrer">Open the original résumé PDF</a></iframe>`;
}
